# Licence for enumerated author-generated data

Copyright © 2026 Hongshan Guo.

The files identified as `CC-BY-4.0` in `LICENSE_MATRIX.tsv` are licensed under
...
No warranty is given. The licence does not imply endorsement and does not
waive privacy, publicity, moral, patent, trademark, database, or other rights
that the licensor does not control.
